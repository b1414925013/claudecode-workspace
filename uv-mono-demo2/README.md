...
├── .gitignore
├── core/                       # 底层公共工具包
├── service_a/                  # 业务项目 A，依赖 core
├── service_b/                  # 业务项目 B，依赖 core + service_a
...
```bash
# 在根目录下新增子项目
mkdir -p my-pkg/src/my_pkg
touch my-pkg/pyproject.toml

# 更新 pyproject.toml 的 workspace members，然后重新安装
uv sync
```
